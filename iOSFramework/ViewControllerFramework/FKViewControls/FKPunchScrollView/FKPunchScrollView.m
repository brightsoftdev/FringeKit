...
#import "FKPunchScrollView.h"

@interface FKPunchScrollView (Private)
...
#pragma mark -
#pragma mark FKPunchScrollView Public Methods
...
- (void)scrollToIndexPath:(NSIndexPath*)indexPath animated:(BOOL)animated
{
    ...
    if (direction_ == FKPunchScrollViewDirectionHorizontal)
    {
    ...
    else if (direction_ == FKPunchScrollViewDirectionVertical)
    {
...
- (void)renderPages 
{
    ...
    if (direction_ == FKPunchScrollViewDirectionVertical)
    {
...
- (void)setPunchDataSource:(id <FKPunchScrollViewDataSource>)thePunchDataSource
{
...
- (void)scrollViewDidScroll:(FKPunchScrollView *)scrollView
{
	[self renderPages];
}

- (void)scrollViewDidEndDecelerating:(FKPunchScrollView *)scrollView 
{
	
    [self pageIndexChanged];
}

- (void)scrollViewDidEndScrollingAnimation:(FKPunchScrollView *)scrollView
{
...
- (void)setDirection:(FKPunchScrollViewDirection)direction
{
